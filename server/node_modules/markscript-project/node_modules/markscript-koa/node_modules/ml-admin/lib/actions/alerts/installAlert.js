var getModule_1 = require('../modules/getModule');
var installModule_1 = require('../modules/installModule');
...
function installAlert(client, config) {
    ...
    return getModule_1.getModule(client, RUN_SJS_PATH).catch(function () {
        return installModule_1.installModule(client, RUN_SJS_PATH, RUN_SJS_CODE);
    }).then(function () {
