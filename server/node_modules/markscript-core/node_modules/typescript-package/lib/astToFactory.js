...
function packageAstToFactory(pkgDir, options, host) {
    ...
    var pkgs = {};
    var p = ts.createProgram(files, options || { target: 1, moduleResolution: 2 }, host);
        ...
        switch (type.flags) {
            ...
            case 512:
                if (!typeParameters[type.symbol.name]) {
                  console.log(type.symbol.parent)
        ...
        nodes.forEach(function (node) {
            switch (node.kind) {
                ...
                case 138:
                    ...
                    propMember.type = processNode(p_1.type, typeParameters);
                    if (p_1.initializer) {
