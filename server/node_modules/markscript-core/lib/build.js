        ...
        function executeTask() {
            ...
            if (!buildModel && !task.requiresFreshModel && persistedModelFileName && fs.existsSync(persistedModelFileName)) {
                ...
                if (!typeModel && self.options.isTypeScript) {
                    ...
                    typeModel = rawPackage_1.construct(s.factoryToReflective())().modules;
                }
                var assetTypeModel = self.options.typeModel;
...
function generateBuildModel(buildConfig, plugins, pkgDir, typeModel, assetTypeModel) {
    var buildModel = {
        databases: {},
        servers: {},
        ruleSets: [],
